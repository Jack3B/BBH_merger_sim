...
SIM_IMAGES_DIR = Path("BBH_SIM/Results/SimImages")
...
def run_single(run_id: int, save_plot: str = None, zoom_au: float = 0.5) -> None:
    ...
    # If no explicit save path given, auto-generate one in SimImages
    if save_plot is None:
        save_plot = str(SIM_IMAGES_DIR / f"orbit_run{run_id}.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save",  type=str,   default=None,
                        help="Override save path (default: BBH_SIM/Results/SimImages/orbit_run{id}.png)")
